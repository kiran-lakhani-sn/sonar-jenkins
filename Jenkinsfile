pipeline {
    ...
    stages {
		...
		//snDevOpsChange() 
	        snDevOpsChange changeRequestDetails: '{ "attributes": {"type": "normal","change_approval_group": "a715cd759f2002002920bde8132e7018","template": "4b175dd20a0a0b99004f35e506563fc6"}}'
